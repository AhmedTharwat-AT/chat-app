  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <p
          className={`${fromYou ? "bg-[var(--color-chat)] " : "bg-white "} break-all rounded-sm p-3 text-base text-gray-800 shadow-md`}
        >
          {msg.content}
        </p>
        <div
        ...
        >
          <h2 className="max-w-[200px] truncate text-xs font-medium uppercase text-gray-900">
